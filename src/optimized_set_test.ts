...
describe('Optimized Set', () => {
    ...
    it('is easier, but still awkward with mixins and currying', () => {
        // Not all langauges have good support for mixins, but if yours does,
        ...
        // Implemnent mutability as a mixin, rather than a class. This way its
